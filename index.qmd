...
- Claude Code has a VS Code extenion, which is similar to Positron Assistant: Both provide chat pane with agentic capabilities
- Assistant is tailored for data science with R and Python; Claude Code more towards general software engineering
- Claude Code can be used in VS Code or Positron; Assistant can only be used in Positron
- Assistant is tightly integrated into Positron IDE (e.g., allows in-line assistance)
- Assistant is BYOK, so can use any LLM backend; Claude Code can only use Claude models
...
- **instructions.md**: Specify custom "always-on" instructions: coding standards, style guides, or best practices for your assistant to follow across all scripts (this specifies the *how*)
  - Alternatively specified in **claude.md** for Claude Code, or **poistitron.md** for Positron Assistant
  - Can also make file-specific instructions
- **prompts.md**: Define reusables prompts for tasks you commonly ask your assistant to do (e.g., "write a function that does X", etc) (this specifies the *what*)
- **agents.md**: Create custom agent personas that can perform specific tasks, such as data cleaning, EDA, or model training (this specifies the *who*)
- **skills.md**: Define custom standardized skills and workflows you want your custom agents to be proficient in (this specifies the *what* + *how* + *who*)
- Learn more [here](https://code.visualstudio.com/docs/copilot/customization/overview)
