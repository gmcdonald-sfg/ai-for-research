...
- **Important**: Both Positon Assistant and Databot require an API key; so this works with pay-as-you-go Claude, but *not* Claude Pro monthly subscription
- Claude Pro can be used with Claude Code VS Code extenion, which is similar to Positron Assistant but less tailored to R and data science. Both can be used in Positron
