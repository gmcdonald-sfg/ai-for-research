...
- **instructions.md**: Specify custom "always-on" instructions: coding standards, style guides, etc to use across all scripts (specify the *how*)
...
- **skills.md**: Define custom standardized skills and workflows you want your custom agents to be proficient in (specify the *what* + *how* + *who*)
